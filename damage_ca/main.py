...
if __name__ == '__main__':
    ...
    parser.add_argument("--mode", type=int, default=2, help="0 for gaussian blur, 1 for pixel removal, 2 for adversarial attacks")
    parser.add_argument("--n_iterations", type=int, default=100000, help="Number of iterations to test for.")
